...
const WhyWe = () => {
  return (
    ...
    <section id="why-we" className="py-5">
  <div className="container">
    <h1 className="text-center mb-5 section-title">Why Choose Us?</h1>
    <div class="accordion accordion-flush" id="accordionFlushExample">
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button
        ...
        >
          <div class="accordion-body">
            At Bsecure Advisory Services, we understand that financial
            decisions are deeply personal and often challenging. We listen to
            your unique story and understand your aspirations and concerns. Our
            empathetic approach ensures that we provide solutions tailored
            specifically to your needs, fostering a sense of trust and comfort.
          </div>
        </div>
      </div>
      <div class="accordion-item">
      ...
      <div class="accordion-item">
        ...
        >
          <div class="accordion-body">
            We are dedicated to delivering excellence in every aspect of our
            service. From initial consultation to the final disbursement, our
            meticulous attention to detail and commitment to quality guarantee a
            seamless experience. We strive to exceed your expectations and help
            you achieve your financial goals with confidence and ease.
          </div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        >
          <div class="accordion-body">
            Trust is the foundation of our relationship with you. Our
            transparent, no-fee consultation process ensures you receive honest
            advice without any hidden costs. We prioritize your best interests
            and uphold the highest standards of integrity in all our
            interactions. You can rely on us to guide you with honesty and
            clarity.
          </div>
        </div>
      ...
      <div class="accordion-item">
        ...
        >
          <div class="accordion-body">
            Your journey with us doesn’t end with the disbursement of a loan or
            the purchase of an insurance policy. We offer ongoing support to
            help you navigate any challenges and make informed financial
            decisions. Our commitment to your long-term success is unwavering,
            ensuring you have a trusted partner by your side at every step.
          </div>
        </div>
