          ...
          <div className="container ">
            <div className="row">
              <div className="col-12 ">
                <h2 className=" my-3 heading-txt text-uppercase ">
                  Contact Us
                </h2>
                {/* <h2 className="display-6 mb-4 mb-md-5 mb-xl-8 border border-3 text-center p-4">
                At Bsecure, we're always eager to work with new clients. Please get in touch with us using one of the following methods.
                </h2> */}
              </div>
            </div>
          </div>
                  ...
                  <div className="col-12 col-xl-11">
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <p className="mb-2">
                          Kindly visit us on our business opening hours.
                        </p>
                        <hr className="w-50 mb-3 border-dark-subtle" />
